...
assert "Belarus" in slovar["country"].values() #проверка - есть ли значение
                                               # "Belarus" в slovar во вложенном словаре"country"


assert "country1" in slovar["country"].keys() #проверка - есть ли ключ
                                               # "country1" в slovar во вложенном словаре"country"